...
public class TopBuyers extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.TOP_BUYERS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                    ...
                    if(!error){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            orderItemsList.add(new SellingItems(
                                    ...
                                    jsonObject2.getString("total_amount_val")
                            ));
                ...
                orderAdapter = new BuyerAdapter(getActivity(), orderItemsList);
